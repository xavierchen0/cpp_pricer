...
public:
  EuropeanOption(const Date &tradeDate, double _notional, double _strike,
  ...
  double ValueAtNode(double S, double t, double continuation) const {
    return continuation;
  }
...
public:
  EuropeanCallSpread(const Date &tradeDate, double _notional, double _k1,
