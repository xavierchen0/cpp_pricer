...
public:
  Option(Date tradeDate, Date expiryDate, Currency tradeCcy,
         ...
         std::shared_ptr<IOptionPricer> optionPricer, double notional,
         double strike)
      : ITrade{TradeType::Option, tradeDate, tradeCcy},
        m_optionRight{optionRight}, m_optionExerciseStyle{optionExerciseStyle},
        m_optionPayoff{std::move(optionPayoff)}, m_optionPricer{optionPricer},
...
private:
  ...
  std::shared_ptr<IOptionPricer> m_optionPricer{};
