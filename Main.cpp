...
int main() {
  ...
  */
  ...
  Trade *bondTrade =
      new Bond(tradeDate, "testBond1", startDate, expiryDate, 100000, 0.025, 1);
  Trade *eCallOption =
      new EuropeanOption(tradeDate, 10000, 100, expiryDate, OptionType::Call);
  Trade *aOption =
      new AmericanOption(tradeDate, 10000, 100, expiryDate, OptionType::Call);
